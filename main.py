...
=======
S_pts = 0 
>>>>>>> f97b332a89add14f847aa19383a71e4ae324ea9f
K_pts = 0
U_pts = 0
N_pts = 0
KK_pts = 0
...
=======
    ...
    # elif dice1 or dice2 == 1:
    #     print(Fore.GREEN + "You rolled a " + str(dice1) + ' and ' + str(dice2) + ' with a total of ' + str(dice_total) + ' points!')
    #     print(Fore.YELLOW + Style.BRIGHT + 'Oh no! At least one of your rolls was a 1, you lost all your points for the [' + str(cur_round) + '] round.')
    #     cur_pts  = 0
    #     moveToNextRound()
...
def nextMove():
    ...
    if choice == '1':
        ...
        print(Fore.RED + Style.BRIGHT + 'Error: Unknown input.')
...
>>>>>>> f97b332a89add14f847aa19383a71e4ae324ea9f
        ...
        round_list = ('S', 'K', 'U', 'N', 'K')
        cur_round = round_list[t]
        print('Next up is the [' + str(cur_round) + '] round. Hit Enter to roll. Good luck!')
        choice = input()
        roll()
